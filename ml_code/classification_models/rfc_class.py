...
def rfc_class(X_train, X_test, y_train, y_test):
    '''
    ...
    params = {
        ...
        'clf__min_samples_split': [4, 8, 10, 15],
    }

    #Initialize the grid search object
    grid_search_rfc = GridSearchCV(pipe, param_grid=params, n_jobs=-1, verbose=2)
    grid_search_rfc.fit(X_train, y_train)

    #Print the best value combination
    print(f"Best paramaters: {grid_search_rfc.best_params_}")
