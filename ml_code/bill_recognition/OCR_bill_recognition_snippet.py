...
pdf2image.convert_from_path(file_in, dpi=400, output_folder= 'C:/Users/bill-/Desktop/', 
                            ...
                            transparent=False, output_file='C:/Users/bill-/Desktop/4a90245d-9f16-413f-8c8d-23469f4775db')
#%%
temp_dir = tmp.gettempdir()
#temp_pics = tmp.SpooledTemporaryFile('C:/Users/bill-/Desktop/4a90245d-9f16-413f-8c8d-23469f4775db', dir = temp_dir)
temp_pics = tmp.TemporaryDirectory(suffix=None, prefix=None, dir=temp_dir)
#%%
####GET A VERSION WITH HASHLIB WORKING!
#OCR process
tools = pyocr.get_available_tools()[0]
text = tools.image_to_string(Image.open(temp_pics), 
...
link = r"C:\Users\bill-\Desktop\*.png" 
#convert backslashes to slashes
new_link = link.replace(os.sep, '/')
#remove those pesky letter strings
new_link_2 = new_link.replace('"', '')
