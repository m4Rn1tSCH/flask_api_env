...
def nn_mod():
    ...
    nn_model = model.fit(train_dataset, epochs=EPOCHS, verbose=2)

    # flask cannot pickle local object; model file cannot be passed to store pickle function
    ...
    # store_pickle(model=nn_model)
    return 'NN-regression finished'
